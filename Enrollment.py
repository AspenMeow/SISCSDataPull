...
class stdntterm:
    ...
    def termenrl(self):
        df = pd.read_sql("select * from (select a.emplid,a.strm,a.term_descrshort,  a.acad_career, a.degree_career,a.enrollment_status, a.residency,a.tuition_res,fin_aid_fed_res,\
